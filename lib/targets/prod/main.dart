...
void main() async {
  ...
  await Firebase.initializeApp(
    options: FirebaseOptions(
      ...
      authDomain: RunConfigurations.firebaseAuthDomain,
      storageBucket: RunConfigurations.firebaseStorageBucket,
      measurementId: RunConfigurations.firebaseMeasurementId,
    ),
  );
